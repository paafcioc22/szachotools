...
namespace App2.View
{
	public class SkanNowy : ContentPage
	{
        ...
        public SkanNowy() : base()
        {
            ...
            buttonScanContinuously.Clicked += async delegate {
                scanPage = new ZXingScannerPage(new ZXing.Mobile.MobileBarcodeScanningOptions { DelayBetweenContinuousScans = 4000 });
                scanPage.OnScanResult += (result) =>
                    Device.BeginInvokeOnMainThread(() =>
